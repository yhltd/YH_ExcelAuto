...
namespace newclscommon
{
    public class NewMySqlHelper
    {
        ...
        private static string connstr = "server=" + "47.52.155.70" + ";user=root;password=Lyh07910;database=soft_time;Convert Zero Datetime=True;Allow Zero Datetime=True;default command timeout=10;Connection Timeout=600";//根据自己的实际
